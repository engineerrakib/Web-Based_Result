...
if (isset($_POST["submit"])) {
  ...
  $q =mysqli_query($al,"UPDATE marks SET s1='$s1',s2='$s2',s3='$s3',s4='$s4',s5='$s5' WHERE id=$id");
...
<body>
  ...
  <div class="container">
	...
	<?php
    $sql =mysqli_query($al,"SELECT * FROM marks WHERE id = $id LIMIT 1");
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div>
          ...
          <a href="viewMarks.php" class="btn btn-danger">Cancel</a>
        </div>
		<br/>
		<br/>
		<br/>
