...
if (isset($_POST["submit"])) {
  ...
  $z =mysqli_query($al,"UPDATE students_final SET name='$name', roll='$roll', sem='$sem', dept='$dept', year='$year' WHERE id = $id");
...
<body>
  ...
  <div class="container">
	...
	<?php
    $sql =mysqli_query($al,"SELECT * FROM students_final WHERE id = $id LIMIT 1");
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div>
          ...
          <a href="viewStudents_Final_Result.php" class="btn btn-danger">Cancel</a>
        </div>
      </form>
    </div>
  </div>
