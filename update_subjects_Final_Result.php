...
$id = $_GET["update-subjects-final"];

if (isset($_POST["submit"])) {
  $s1 = $_POST['s1'];

  $u =mysqli_query($al,"UPDATE subjects_final SET s1='$s1' WHERE id=$id");
...
<body>
  ...
  <div class="container">
	...
	<?php
    $sql =mysqli_query($al,"SELECT * FROM subjects_final WHERE id = $id LIMIT 1");
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div>
          ...
          <a href="viewSubjects_Final_Result.php" class="btn btn-danger">Cancel</a>
        </div>
		<br/>
		<br/>
		<br/>
