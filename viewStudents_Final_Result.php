...
<body class="table-view">
		...
		<table id="example" class="table table-hover table-bordered text-center" style="width:100%">
		  ...
		  <tbody>
				<?php
				$i=1;
				$x=mysqli_query($al,"SELECT * FROM students_final WHERE sem='$sem' AND dept='$dept'");
			  ...
			  <tr>
				...
				<td>
				  <a href="update_students_Final_Result.php?update-student-final=<?php echo $row["id"];?>" class="link-dark" onclick="return confirm('Are You Sure..?');"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
				  <a href="delete_students_Final_Result.php?del-student-final=<?php echo $row["id"];?>" class="link-dark" onclick="return confirm('Are You Sure..?');"><i class="fa-solid fa-trash fs-5"></i></a>
				</td>
			  </tr>
			<?php
			}
