...
if (isset($_POST["submit"])) {
  ...
  $u =mysqli_query($al,"UPDATE faculty SET name='$name', sem='$sem', dept='$dept', email='$email', password='$password' WHERE id=$id");
...
<body>
  ...
  <div class="container">
	...
	<?php
    $sql =mysqli_query($al,"SELECT * FROM faculty WHERE id = $id LIMIT 1");
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div>
          ...
          <a href="viewUser_List.php" class="btn btn-danger">Cancel</a>
        </div>
		<br/>
		<br/>
		<br/>
