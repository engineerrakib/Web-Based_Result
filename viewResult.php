...
<body>
	...
	<h3 class="result-view-h3">WEB BASED SEMESTER RESULT TRANSCRIPT</h3>
		...
		<table id="marksheet-table">
			<?php 
				$x=mysqli_query($al,"SELECT * FROM students WHERE roll='$roll' AND sem='$sem'");
			...
			<?php $m=mysqli_query($al,"SELECT * FROM subjects WHERE sem='$sem' AND dept='$dept'");
