		...
		<table class="table table-hover table-bordered border-dark text-center">
		  ...
		  <tbody>
			  ...
			  <tr>
				...
				<td>
				  <a href="update_subjects_Final_Result.php?update-subjects-final=<?php echo $row["id"];?>" class="link-dark" onclick="return confirm('Are You Sure..?');"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
				  <a href="delete_subjects_Final_Result.php?del-subjects-final=<?php echo $row["id"];?>" class="link-dark" onclick="return confirm('Are You Sure..?');"><i class="fa-solid fa-trash fs-5"></i></a>
				</td>
			  </tr>
			<?php
			}
